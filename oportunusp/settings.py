"""
Django settings for oportunusp project.
...
SECRET_KEY = 'django-insecure-!@+#g!zi-c!1@=pae-fi30s*29qx+&9b8$)yg20jg@e@bsgb4x'
...
WSGI_APPLICATION = 'oportunusp.wsgi.application'
...
EMAIL_HOST = 'smtp.gmail.com'  # Altere para o servidor de e-mail que você usará
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'oportunusp@gmail.com'
EMAIL_HOST_PASSWORD = 'alej vymi utnr nwsw'  # Use uma senha de aplicativo se estiver usando Gmail
